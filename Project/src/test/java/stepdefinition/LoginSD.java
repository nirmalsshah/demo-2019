...
public class LoginSD {
    ...
    @When("^I click on exclamation icon$")
    public void clickOnExclamationIcon(){
        homePage.clickOnErrorIcon();
    }

    @Then("^I should see invalid email error popup$")
    public void invalidErrorMessage(){
        Assert.assertEquals(homePage.getErrorPopupText(), "Please enter a valid mobile number or email address.");
    }
