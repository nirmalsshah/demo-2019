...
Feature: Login feature
  ...
  Scenario Outline: Signup form should not accept any invalid email address
     When I enter Nirmal into firstname text fields on home screen
     And I enter Shah into lastname text fields on home screen
     And I enter <InvalidEmails> into mobile number text fields on home screen
     And I click on password field
     And I click on exclamation icon
     Then I should see invalid email error popup
